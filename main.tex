...
\tikzstyle{process2} = [rectangle, minimum width=2cm, minimum height=1cm, text centered, text width=2cm, draw=black]
% Gap definitions
...
\fancyhead[LE]{\small\sc Aporia Vol. 26}
\fancyhead[RE]{\small\sc\itshape\leftmark}
\fancyhead[LO]{\small\sc Aporia Vol. 26}
