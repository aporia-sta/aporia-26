Polishing the Causal Stream: A Pluralistic Reading of the \emph{Platform
Sutra} and a Parfitian critique of the traditional interpretation

Abstract: \emph{The} \emph{Platform Sutra of the Sixth Patriarch} is a
pivotal text in Chinese Buddhist philosophy, traditionally interpreted
as establishing the orthodoxy of the Southern "Sudden" school of Chan
Buddhism while relegating the Northern "Gradual" school to a provisional
teaching. To understand this schism, one must understand the mechanics
of Buddhist soteriology: enlightenment fundamentally requires liberation
from the "psychological stream" - the continuous, causally linked flow
of mental states, habits, and karmic dispositions that perpetuates the
illusion of a permanent self. This paper argues that the traditional
interpretation fails to properly address this causal reality by making a
fatal logical leap from necessity to sufficiency. By claiming that a
sudden, propositional insight into the emptiness of the self is entirely
sufficient for enlightenment, the orthodoxy invites antinomianism and
dogmatically dismisses the Northern method of cultivation. Drawing upon
Derek Parfit's reductionist metaphysics and Gilbert Ryle's epistemology,
I argue that the Northern school's gradual approach does not mistakenly
reify a Cartesian ego but is rather strictly necessary to convert the
propositional truth of emptiness (knowing-that) into the dispositional
purity of enlightened living (knowing-how). Ultimately, this paper
rehabilitates the \emph{Platform Sutra} as espousing a methodological
pluralism: true liberation requires both the sudden, conceptual
destruction of the ego and the continuous, gradual cultivation of one's
dispositions.
...
In Chinese Buddhist philosophy, the \emph{Platform Sutra of the Sixth
Patriarch} is regarded as the definitive manifesto of the "Southern
...
shared "East Mountain" teachings of the Fifth Patriarch,
Hongren.\footnote{John R. McRae, \emph{The Northern School and the
  ...
  Mountain Teaching" as the shared progenitor of both schools).} The
doctrines coincide in their understanding of enlightenment as a
liberation from \emph{Samsara -} the cycle of life and death - through a
detachment from worldly desire. However, both schools diverge in their
interpretations of what this detachment consists of, and how it can be
achieved.
...
Table 1: The Traditional Interpretation's Characterisation of the
Soteriological Divide

\begin{longtable}[]{@{}lll@{}}
\toprule
& Nature of enlightenment & Method of attainment\tabularnewline
\midrule
\endhead
Northern school & A dispositional and recurrent state of purified moral
and cognitive habits; the continuous maintenance of an unattached mind,
free from worldly striving, which ultimately secures liberation from
\emph{samsara} and the cessation of suffering. & Gradual character
cultivation, sustained meditation, and continuous moral vigilance to
prevent moral defilement.\tabularnewline
Southern school & An occurrent, transformative realisation of a
propositional truth: the ontological emptiness of the self and the
inherent purity of the mind, which directly results in liberation from
\emph{samsara} and the cessation of suffering. & Direct, unmediated
intuitive awakening; a sudden paradigm shift that bypasses conceptual
study.\tabularnewline
\bottomrule
\end{longtable}

According to the traditional interpretation, the doctrinal divergence
...
\setcounter{enumi}{1}
\item
  \textbf{The key verses of the Platform Sutra}
\end{enumerate}
...
Within the narrative, Shenxiu's verse is treated as an incomplete
...
framework is provisional rather than ultimat. After Shenxiu, the
...
何处惹尘埃)\footnote{Yampolsky, The Platform Sutra, 132.}
\end{quote}

In contrast to Shenxiu, Huineng is celebrated by the Fifth Patriarch in
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{The traditional interpretation}
\end{enumerate}
...
\setcounter{enumi}{1}
\item
  \textbf{Semantic ambiguity and Huineng's ontology}
\end{enumerate}
...
yī wù}, 本来无一物). The main challenge in understanding this assertion
...
Reading 1: The Nihilistic Reading ("Single thing" = Anything)

If "a single thing" is read as `anything', then the statement denies the
existence of any objects (variables) whatsoever within the domain.

¬∃x(x=x)

Reading 2: The Anti-Monistic Reading ("Single thing" = One thing)

If the word "single" is read instead as a numerical quantifier
...
Reading 3: The Anti-Pluralistic Reading ("Single thing" = Distinct
thing)

If "a single thing" is read as a substantive, independent entity
...
Which of these readings is the most plausible? We can immediately reject
...
This passage serves a crucial philosophical purpose: it definitively
...
not a single thing," he is using the formulation ¬∃x∃y(x≠y) to make a
...
identity: ∀x∀y(x=y) (everything is identical to everything else). When
we combine this anti-pluralistic premise (∀x∀y(x=y)) with our rejection
of the nihilistic reading, the conclusion is that Huineng is asserting
that there exists \emph{exactly one} thing ∃x(x=x∧∀y(y=x)).
...
xìng}, 佛性). The denial of pluralistic boundaries is the ontological
...
\setcounter{enumi}{2}
\item
  \textbf{Monism and Antinomianism}
\end{enumerate}
...
Repentance" (\emph{wú xiàng chàn huǐ}, 无相忏悔) upon his disciples,
...
Non-reductionism (The Cartesian View): this view holds that personal
...
Reductionism (The Bundle View): Parfit, aligning with Hume and orthodox
...
Applying these categories provides the necessary lens to interpret
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Identity vs. Survival: The Independence of Relation R}
\end{enumerate}
...
\emph{is} {[}\emph{shì}, 是{]} a bodhi tree," his second line
deliberately shifts to a simile: "The mind is \emph{like} {[}\emph{rú},
如{]} a bright mirror stand." From this, we can grant that Shenxiu is
...
\setcounter{enumi}{3}
\item
  \textbf{The epistemology of enlightenment with lessons from Ryle}
\end{enumerate}
...
Knowing-That (Propositional Knowledge): the possession of information or
theoretical truth (e.g., knowing \emph{that} a bicycle functions via
gyroscopic force).

Knowing-How (Dispositional Skill): the capacity to perform a task or
...
Crucially, Ryle argues that these two categories are fundamentally
...
\setcounter{enumi}{4}
\item
  \textbf{The Pluralistic Synthesis: Narrative Logic and the Necessity
  of Insight}
\end{enumerate}
...
directs the practitioner toward absolute detachment from worldly desire
- the advice to cultivate one's moral character degrades into mere
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Historical Precedents for Methodological Pluralism}
\end{enumerate}
...
Awakening followed by Gradual Cultivation'' (dùn wù jiàn xiū, 顿悟渐修).
...
This metaphor directly maps onto our previous analysis. The ``sudden
...
In Parfitian terms, Zongmi is illustrating the independence of Relation
